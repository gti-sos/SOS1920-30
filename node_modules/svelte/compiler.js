(function (global, factory) {
	...
	function traverse_destructure_pattern(node, callback) {
	...
	class SlotWrapper extends Wrapper {
	    constructor(renderer, block, parent, node, strip_whitespace, next_sibling) {
	        ...
	        this.fragment = new FragmentWrapper(renderer, this.fallback, node.children, parent, strip_whitespace, next_sibling);
	...
	class Component {
	    ...
	    generate(result) {
	        ...
	        if (result) {
	            ...
	            const banner = `${this.file ? `${this.file} ` : ``}generated by Svelte v${'3.20.1'}`;
